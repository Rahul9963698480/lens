import { AnnotationsTab } from '@/components/tables/annotations-tab'
    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      <div className="shrink-0 border-b px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          <p className="m-0 text-lg font-medium tracking-tight text-foreground">
            {tableName}
          </p>
          {rowCount > 0 && (
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden px-6 py-4">
        <Tabs defaultValue="preview" className="flex min-h-0 flex-1 flex-col">
          ...
          <TabsContent value="annotations" className="min-h-0 overflow-y-auto">
            <AnnotationsTab projectId={projectId} schemaTable={schemaTable} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
